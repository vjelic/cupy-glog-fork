...
IF CUPY_HIP_VERSION != 0:
    cpdef enum:
        CUDNN_DATA_FLOAT = 200
        CUDNN_DATA_DOUBLE = 201
        CUDNN_DATA_HALF = 202
    
        CUDNN_DEFAULT_MATH = 210
        CUDNN_TENSOR_OP_MATH = 211
    
        CUDNN_NOT_PROPAGATE_NAN = 220
        CUDNN_PROPAGATE_NAN = 221
    
        CUDNN_NON_DETERMINISTIC = 230
        CUDNN_DETERMINISTIC = 231
    
        CUDNN_TENSOR_NCHW = 240
        CUDNN_TENSOR_NHWC = 241
    
        CUDNN_OP_TENSOR_ADD = 250
        CUDNN_OP_TENSOR_MUL = 251
        CUDNN_OP_TENSOR_MIN = 252
        CUDNN_OP_TENSOR_MAX = 253
        CUDNN_OP_TENSOR_SQRT = 254
        CUDNN_OP_TENSOR_NOT = 255
    
        CUDNN_REDUCE_TENSOR_ADD = 260
        CUDNN_REDUCE_TENSOR_MUL = 261
        CUDNN_REDUCE_TENSOR_MIN = 262
        CUDNN_REDUCE_TENSOR_MAX = 263
        CUDNN_REDUCE_TENSOR_AMAX = 264
        CUDNN_REDUCE_TENSOR_AVG = 265
        CUDNN_REDUCE_TENSOR_NORM1 = 266
        CUDNN_REDUCE_TENSOR_NORM2 = 267
        CUDNN_REDUCE_TENSOR_MUL_NO_ZEROS = 268
    
        CUDNN_REDUCE_TENSOR_NO_INDICES = 270
        CUDNN_REDUCE_TENSOR_FLATTENED_INDICES = 271
    
        CUDNN_32BIT_INDICES = 280
        CUDNN_64BIT_INDICES = 281
        CUDNN_16BIT_INDICES = 282
        CUDNN_8BIT_INDICES = 283
    
        CUDNN_ADD_IMAGE = 290
        CUDNN_ADD_SAME_HW = 290
        CUDNN_ADD_FEATURE_MAP = 291
        CUDNN_ADD_SAME_CHW = 291
        CUDNN_ADD_SAME_C = 292
        CUDNN_ADD_FULL_TENSOR = 293
    
        CUDNN_CONVOLUTION = 300
        CUDNN_CROSS_CORRELATION = 301
    
        CUDNN_CONVOLUTION_FWD_NO_WORKSPACE = 310
        CUDNN_CONVOLUTION_FWD_PREFER_FASTEST = 311
        CUDNN_CONVOLUTION_FWD_SPECIFY_WORKSPACE_LIMIT = 312
    
        CUDNN_CONVOLUTION_FWD_ALGO_IMPLICIT_GEMM = 320
        CUDNN_CONVOLUTION_FWD_ALGO_IMPLICIT_PRECOMP_GEMM = 321
        CUDNN_CONVOLUTION_FWD_ALGO_GEMM = 322
        CUDNN_CONVOLUTION_FWD_ALGO_DIRECT = 323
        CUDNN_CONVOLUTION_FWD_ALGO_FFT = 324
        CUDNN_CONVOLUTION_FWD_ALGO_FFT_TILING = 325
        CUDNN_CONVOLUTION_FWD_ALGO_WINOGRAD = 326
        CUDNN_CONVOLUTION_FWD_ALGO_WINOGRAD_NONFUSED = 327
    
        CUDNN_CONVOLUTION_BWD_FILTER_NO_WORKSPACE = 330
        CUDNN_CONVOLUTION_BWD_FILTER_PREFER_FASTEST = 331
        CUDNN_CONVOLUTION_BWD_FILTER_SPECIFY_WORKSPACE_LIMIT = 332
    
        CUDNN_CONVOLUTION_BWD_FILTER_ALGO_0 = 340
        CUDNN_CONVOLUTION_BWD_FILTER_ALGO_1 = 341
        CUDNN_CONVOLUTION_BWD_FILTER_ALGO_FFT = 342
        CUDNN_CONVOLUTION_BWD_FILTER_ALGO_3 = 343
        CUDNN_CONVOLUTION_BWD_FILTER_ALGO_WINOGRAD = 344
        CUDNN_CONVOLUTION_BWD_FILTER_ALGO_WINOGRAD_NONFUSED = 345
    
        CUDNN_CONVOLUTION_BWD_DATA_NO_WORKSPACE = 350
        CUDNN_CONVOLUTION_BWD_DATA_PREFER_FASTEST = 351
        CUDNN_CONVOLUTION_BWD_DATA_SPECIFY_WORKSPACE_LIMIT = 352
    
        CUDNN_CONVOLUTION_BWD_DATA_ALGO_0 = 360
        CUDNN_CONVOLUTION_BWD_DATA_ALGO_1 = 361
        CUDNN_CONVOLUTION_BWD_DATA_ALGO_FFT = 362
        CUDNN_CONVOLUTION_BWD_DATA_ALGO_FFT_TILING = 363
        CUDNN_CONVOLUTION_BWD_DATA_ALGO_WINOGRAD = 364
        CUDNN_CONVOLUTION_BWD_DATA_ALGO_WINOGRAD_NONFUSED = 365
    
        CUDNN_SOFTMAX_FAST = 370
        CUDNN_SOFTMAX_ACCURATE = 371
        CUDNN_SOFTMAX_LOG = 372
    
        CUDNN_SOFTMAX_MODE_INSTANCE = 380
        CUDNN_SOFTMAX_MODE_CHANNEL = 381
    
        CUDNN_POOLING_MAX = 390
        CUDNN_POOLING_AVERAGE_COUNT_INCLUDE_PADDING = 391
        CUDNN_POOLING_AVERAGE_COUNT_EXCLUDE_PADDING = 392
        CUDNN_POOLING_MAX_DETERMINISTIC = 393
    
        CUDNN_ACTIVATION_SIGMOID = 400
        CUDNN_ACTIVATION_RELU = 401
        CUDNN_ACTIVATION_TANH = 402
        CUDNN_ACTIVATION_CLIPPED_RELU = 403
        CUDNN_ACTIVATION_ELU = 404
        CUDNN_ACTIVATION_IDENTITY = 405
    
        CUDNN_LRN_CROSS_CHANNEL_DIM1 = 410
    
        CUDNN_DIVNORM_PRECOMPUTED_MEANS = 420
    
        CUDNN_BATCHNORM_PER_ACTIVATION = 430
        CUDNN_BATCHNORM_SPATIAL = 431
        CUDNN_BATCHNORM_SPATIAL_PERSISTENT = 432
    
        CUDNN_CTC_LOSS_ALGO_DETERMINISTIC = 440
        CUDNN_CTC_LOSS_ALGO_NON_DETERMINISTIC = 441
    
        CUDNN_BATCHNORM_OPS_BN = 450
        CUDNN_BATCHNORM_OPS_BN_ACTIVATION = 451
        CUDNN_BATCHNORM_OPS_BN_ADD_ACTIVATION = 452
        ...
        CUDNN_UNIDIRECTIONAL = 470
        CUDNN_BIDIRECTIONAL = 471
    
        CUDNN_RNN_ALGO_STANDARD = 480
        CUDNN_RNN_ALGO_PERSIST_STATIC = 481
        CUDNN_RNN_ALGO_PERSIST_DYNAMIC = 482
    
        CUDNN_RNN_DATA_LAYOUT_SEQ_MAJOR_UNPACKED = 490
        CUDNN_RNN_DATA_LAYOUT_SEQ_MAJOR_PACKED = 491
        CUDNN_RNN_DATA_LAYOUT_BATCH_MAJOR_UNPACKED = 492
    
        CUDNN_RNN_PADDED_IO_DISABLED = 500
        CUDNN_RNN_PADDED_IO_ENABLED = 501
    
        CUDNN_LINEAR_INPUT = 510
        CUDNN_SKIP_INPUT = 511
    
        CUDNN_SAMPLER_BILINEAR = 520
    
        CUDNN_STATUS_SUCCESS = 530
        CUDNN_STATUS_RUNTIME_PREREQUISITE_MISSING = 541
        CUDNN_STATUS_RUNTIME_IN_PROGRESS = 542
        CUDNN_STATUS_RUNTIME_FP_OVERFLOW = 543
    
        CUDNN_ERRQUERY_RAWCODE = 550
        CUDNN_ERRQUERY_NONBLOCKING = 551
        CUDNN_ERRQUERY_BLOCKING = 552
    
        # cudnnFusedOps_t
        CUDNN_FUSED_SCALE_BIAS_ACTIVATION_CONV_BNSTATS = 560
        CUDNN_FUSED_SCALE_BIAS_ACTIVATION_WGRAD = 561
        CUDNN_FUSED_BN_FINALIZE_STATISTICS_TRAINING = 562
        CUDNN_FUSED_BN_FINALIZE_STATISTICS_INFERENCE = 563
        CUDNN_FUSED_CONV_SCALE_BIAS_ADD_ACTIVATION = 564
        CUDNN_FUSED_SCALE_BIAS_ADD_ACTIVATION_GEN_BITMASK = 565
        CUDNN_FUSED_DACTIVATION_FORK_DBATCHNORM = 566
    
        # cudnnFusedOpsConstParamLabel_t
        CUDNN_PARAM_XDESC = 570
        CUDNN_PARAM_XDATA_PLACEHOLDER = 571
        CUDNN_PARAM_BN_MODE = 572
        CUDNN_PARAM_BN_EQSCALEBIAS_DESC = 573
        CUDNN_PARAM_BN_EQSCALE_PLACEHOLDER = 574
        CUDNN_PARAM_BN_EQBIAS_PLACEHOLDER = 575
        CUDNN_PARAM_ACTIVATION_DESC = 576
        CUDNN_PARAM_CONV_DESC = 577
        CUDNN_PARAM_WDESC = 578
        CUDNN_PARAM_WDATA_PLACEHOLDER = 579
        CUDNN_PARAM_DWDESC = 580
        CUDNN_PARAM_DWDATA_PLACEHOLDER = 581
        CUDNN_PARAM_YDESC = 582
        CUDNN_PARAM_YDATA_PLACEHOLDER = 583
        CUDNN_PARAM_DYDESC = 584
        CUDNN_PARAM_DYDATA_PLACEHOLDER = 585
        CUDNN_PARAM_YSTATS_DESC = 586
        CUDNN_PARAM_YSUM_PLACEHOLDER = 587
        CUDNN_PARAM_YSQSUM_PLACEHOLDER = 588
        CUDNN_PARAM_BN_SCALEBIAS_MEANVAR_DESC = 589
        CUDNN_PARAM_BN_SCALE_PLACEHOLDER = 590
        CUDNN_PARAM_BN_BIAS_PLACEHOLDER = 591
        CUDNN_PARAM_BN_SAVED_MEAN_PLACEHOLDER = 592
        CUDNN_PARAM_BN_SAVED_INVSTD_PLACEHOLDER = 593
        CUDNN_PARAM_BN_RUNNING_MEAN_PLACEHOLDER = 594
        CUDNN_PARAM_BN_RUNNING_VAR_PLACEHOLDER = 595
        CUDNN_PARAM_ZDESC = 596
        CUDNN_PARAM_ZDATA_PLACEHOLDER = 597
        CUDNN_PARAM_BN_Z_EQSCALEBIAS_DESC = 598
        CUDNN_PARAM_BN_Z_EQSCALE_PLACEHOLDER = 599
        CUDNN_PARAM_BN_Z_EQBIAS_PLACEHOLDER = 600
        CUDNN_PARAM_ACTIVATION_BITMASK_DESC = 601
        CUDNN_PARAM_ACTIVATION_BITMASK_PLACEHOLDER = 602
        CUDNN_PARAM_DXDESC = 603
        CUDNN_PARAM_DXDATA_PLACEHOLDER = 604
        CUDNN_PARAM_DZDESC = 605
        CUDNN_PARAM_DZDATA_PLACEHOLDER = 606
        CUDNN_PARAM_BN_DSCALE_PLACEHOLDER = 607
        CUDNN_PARAM_BN_DBIAS_PLACEHOLDER = 608
    
        # cudnnFusedOpsPointerPlaceHolder_t
        CUDNN_PTR_NULL = 610
        CUDNN_PTR_ELEM_ALIGNED = 611
        CUDNN_PTR_16B_ALIGNED = 612
    
        # cudnnFusedOpsVariantParamLabel_t
        CUDNN_PTR_XDATA = 620
        CUDNN_PTR_BN_EQSCALE = 621
        CUDNN_PTR_BN_EQBIAS = 622
        CUDNN_PTR_WDATA = 623
        CUDNN_PTR_DWDATA = 624
        CUDNN_PTR_YDATA = 625
        CUDNN_PTR_DYDATA = 626
        CUDNN_PTR_YSUM = 627
        CUDNN_PTR_YSQSUM = 628
        CUDNN_PTR_WORKSPACE = 629
        CUDNN_PTR_BN_SCALE = 630
        CUDNN_PTR_BN_BIAS = 631
        CUDNN_PTR_BN_SAVED_MEAN = 632
        CUDNN_PTR_BN_SAVED_INVSTD = 633
        CUDNN_PTR_BN_RUNNING_MEAN = 634
        CUDNN_PTR_BN_RUNNING_VAR = 635
        CUDNN_PTR_ZDATA = 636
        CUDNN_PTR_BN_Z_EQSCALE = 637
        CUDNN_PTR_BN_Z_EQBIAS = 638
        CUDNN_PTR_ACTIVATION_BITMASK = 639
        CUDNN_PTR_DXDATA = 640
        CUDNN_PTR_DZDATA = 641
        CUDNN_PTR_BN_DSCALE = 642
        CUDNN_PTR_BN_DBIAS = 643
        CUDNN_SCALAR_SIZE_T_WORKSPACE_SIZE_IN_BYTES = 720
        CUDNN_SCALAR_INT64_T_BN_ACCUMULATION_COUNT = 721
        CUDNN_SCALAR_DOUBLE_BN_EXP_AVG_FACTOR = 722
        CUDNN_SCALAR_DOUBLE_BN_EPSILON = 723
ELSE:
    cpdef enum:
        CUDNN_DATA_FLOAT = 0
        CUDNN_DATA_DOUBLE = 1
