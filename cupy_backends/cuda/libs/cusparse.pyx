...
IF CUPY_USE_GEN_HIP_CODE:
    from cupy_backends.cuda.libs.cusparse_hip import *
ELSE:
    ...
    cdef extern from '../../cupy_sparse.h' nogil:
        ...
        Status cusparseCcsrgeam(
            ...
            const int *csrColIndA, const cuComplex *beta,
            const MatDescr descrB,
        ...
        Status cusparseZcsrgemm(
            ...
            const int *csrRowPtrA, const int *csrColIndA,
            const MatDescr descrB,
            const int nnzB, const cuDoubleComplex *csrValB,
            const int *csrRowPtrB, const int *csrColIndB,
        ...
        Status cusparseCcsrgemm2(
            ...
            const MatDescr descrB,
            int nnzB, const cuComplex *csrValB, const int *csrRowPtrB,
            const int *csrColIndB, const cuComplex *beta,
            const MatDescr descrD,
        ...
        cusparseStatus_t cusparseZgtsvInterleavedBatch_bufferSizeExt(
            ...
            const cuDoubleComplex *d, const cuDoubleComplex *du,
            const cuDoubleComplex *x, int batchCount,
            size_t *pBufferSizeInBytes)
        ...
        Status cusparseSpVecGet(SpVecDescr spVecDescr, int64_t* size,
                                int64_t* nnz,
                                void** indices, void** values,
                                IndexType* idxType,
                                IndexBase* idxBase, DataType* valueType)
        Status cusparseSpVecGetIndexBase(SpVecDescr spVecDescr,
                                         IndexBase* idxBae)
        ...
        Status cusparseCooGet(SpMatDescr spMatDescr, int64_t* rows,
                              int64_t* cols,
        ...
        Status cusparseCooAoSGet(SpMatDescr spMatDescr, int64_t* rows,
                                 ...
                                 void** cooValues, IndexType* idxType,
                                 IndexBase* idxBase, DataType* valueType)
        Status cusparseCsrGet(SpMatDescr spMatDescr, int64_t* rows,
                              int64_t* cols,
                              int64_t* nnz, void** csrRowOffsets,
                              void** csrColInd,
                              void** csrValues, IndexType* csrRowOffsetsType,
                              IndexType* csrColIndType, IndexBase* idxBase,
                              DataType* valueType)
        Status cusparseCsrSetPointers(SpMatDescr spMatDescr,
                                      void* csrRowOffsets,
                                      void* csrColInd, void* csrValues)
        Status cusparseSpMatGetFormat(SpMatDescr spMatDescr, Format* format)
        Status cusparseSpMatGetIndexBase(SpMatDescr spMatDescr,
                                         IndexBase* idxBase)
        ...
        Status cusparseSpMatGetSize(SpMatDescr spMatDescr, int64_t* rows,
                                    int64_t* cols, int64_t* nnz)
        Status cusparseSpMatGetStridedBatch(SpMatDescr spMatDescr,
                                            int* batchCount)
        Status cusparseSpMatSetStridedBatch(SpMatDescr spMatDescr,
                                            int batchCount)
        ...
        Status cusparseDnMatGetStridedBatch(DnMatDescr dnMatDescr,
                                            int* batchCount,
                                            int64_t *batchStride)
        Status cusparseDnMatSetStridedBatch(DnMatDescr dnMatDescr,
                                            int batchCount,
                                            int64_t batchStride)
        ...
        Status cusparseSpVV(Handle handle, Operation opX, SpVecDescr vecX,
                            DnVecDescr vecY, void* result,
                            DataType computeType,
                            void* externalBuffer)
        Status cusparseSpMV_bufferSize(Handle handle, Operation opA,
                                       void* alpha,
        ...
        Status cusparseSpMV(Handle handle, Operation opA, void* alpha,
                            ...
                            void* externalBuffer)
        Status cusparseSpMM_bufferSize(Handle handle, Operation opA,
                                       Operation opB,
    ...
    cdef f_type cusparseSparseToDense_bufferSize = \
                    <f_type>_lib.get('SparseToDense_bufferSize')  # NOQA
    ...
    cpdef spMatSetAttribute(size_t spMatDescr, int attribute, int data):
        # Assuming the value of attribute is an enum value, whose underlying
        # type
    ...
    cpdef setStream(intptr_t handle, size_t stream):
        # TODO(leofang): It seems most of cuSPARSE APIs support stream capture
    ...
    cpdef scsrsm2_bufferSizeExt(
            ...
            int ldb, size_t info, int policy):
    ...
    cpdef scsrsm2_analysis(
            ...
            int nnz, size_t alpha, size_t descrA, size_t csrSortedValA,
            size_t csrSortedRowPtrA, size_t csrSortedColIndA, size_t B,
            int ldb, size_t info, int policy, size_t pBuffer):
        _setStream(handle)
        status = cusparseScsrsm2_analysis(
            <Handle>handle, algo, <Operation>transA, <Operation>transB, m,
            nrhs, nnz, <const float*>alpha, <const MatDescr>descrA,
    ...
    cpdef size_t zcsrgeam2_bufferSizeExt(
        ...
        status = cusparseZcsrgeam2_bufferSizeExt(
            ...
            <const int *>csrRowPtrB, <const int *>csrColIndB,
            <const MatDescr>descrC, <cuDoubleComplex *>csrValC,
            <int *>csrRowPtrC, <int *>csrColIndC, &bufferSize)
        check_status(status)
        return bufferSize
    ...
    cpdef size_t zcsrgeam2(
        ...
        status = cusparseZcsrgeam2(
            ...
            <const int *>csrRowPtrB, <const int *>csrColIndB,
            <const MatDescr>descrC, <cuDoubleComplex *>csrValC,
            <int *>csrRowPtrC, <int *>csrColIndC, <void*>buffer)
        check_status(status)
    ...
    cpdef scsrgemm2(
        ...
        status = cusparseScsrgemm2(
            ...
            <int*>csrRowPtrD, <int*>csrColIndD, <MatDescr>descrC,
            <float*>csrValC,
    ...
    cpdef zcsrgemm2(
        ...
        status = cusparseZcsrgemm2(
            ...
            <int*>csrColIndA,
            <MatDescr>descrB, nnzB, <cuDoubleComplex*>csrValB,
            <int*>csrRowPtrB,
    ...
    cpdef xcoo2csr(
            intptr_t handle, size_t cooRowInd, int nnz, int m,
            size_t csrRowPtr, int idxBase):
        _setStream(handle)
        status = cusparseXcoo2csr(
    ...
    cpdef xcsr2coo(
            intptr_t handle, size_t csrRowPtr, int nnz, int m,
            size_t cooRowInd, int idxBase):
        _setStream(handle)
        status = cusparseXcsr2coo(
    ...
    cpdef znnz_compress(
        ...
        status = cusparseZnnz_compress(
            <Handle>handle, m, <const MatDescr>descr,
            <const cuDoubleComplex *>values, <const int *>rowPtr,
            <int *>nnzPerRow,
    ...
    cpdef dcsr2csr_compress(
        ...
        status = cusparseDcsr2csr_compress(
            <Handle>handle, m, n, <MatDescr>descrA,
            <const double *>inVal, <const int *>inColInd,
            <const int *>inRowPtr,
    ...
    cpdef ccsr2csr_compress(
        ...
        status = cusparseCcsr2csr_compress(
            <Handle>handle, m, n, <MatDescr>descrA,
            <const cuComplex *>inVal, <const int *>inColInd,
            <const int *>inRowPtr,
    ...
    cpdef zcsr2csr_compress(
        ...
        status = cusparseZcsr2csr_compress(
            ...
            <const cuDoubleComplex *>inVal, <const int *>inColInd,
            <const int *>inRowPtr,
            inNnz, <int *>nnzPerRow, <cuDoubleComplex *>outVal,
            <int *>outColInd,
    ...
    cpdef xcoosortByRow(
            intptr_t handle, int m, int n, int nnz, size_t cooRows,
            size_t cooCols, size_t P, size_t pBuffer):
        _setStream(handle)
        status = cusparseXcoosortByRow(
    ...
    cpdef xcsrsort(
        ...
        status = cusparseXcsrsort(
            ...
            <const int *>csrRowPtr, <int *>csrColInd, <int *>P,
            <void *>pBuffer)
        check_status(status)
    ...
    cpdef xcscsort(
        ...
        status = cusparseXcscsort(
            <Handle>handle, m, n, nnz, <const MatDescr>descrA,
            <const int *>cscColPtr, <int *>cscRowInd, <int *>P,
            <void *>pBuffer)
        check_status(status)
    ...
    cpdef scsrilu02_numericBoost(intptr_t handle, size_t info,
                                 int enable_boost,
    ...
    cpdef dcsrilu02_numericBoost(intptr_t handle, size_t info,
                                 int enable_boost,
                                 size_t tol, size_t boost_val):
        _setStream(handle)
        with nogil:
    ...
    cpdef ccsrilu02_numericBoost(intptr_t handle, size_t info,
                                 int enable_boost,
                                 size_t tol, size_t boost_val):
        _setStream(handle)
        with nogil:
    ...
    cpdef zcsrilu02_numericBoost(intptr_t handle, size_t info,
                                 int enable_boost,
                                 size_t tol, size_t boost_val):
        _setStream(handle)
        with nogil:
    ...
    cpdef int scsrilu02_bufferSize(intptr_t handle, int m, int nnz,
                                   size_t descrA, size_t csrSortedValA,
                                   size_t csrSortedRowPtrA,
                                   size_t csrSortedColIndA, size_t info):
        cdef int pBufferSizeInBytes
        _setStream(handle)
        with nogil:
            status = cusparseScsrilu02_bufferSize(
                <cusparseHandle_t>handle, m, nnz,
                <const cusparseMatDescr_t>descrA,
                <float*>csrSortedValA, <const int*>csrSortedRowPtrA,
    ...
    cpdef int dcsrilu02_bufferSize(intptr_t handle, int m, int nnz,
                                   size_t descrA, size_t csrSortedValA,
                                   size_t csrSortedRowPtrA,
                                   size_t csrSortedColIndA, size_t info):
        cdef int pBufferSizeInBytes
    ...
    cpdef int ccsrilu02_bufferSize(intptr_t handle, int m, int nnz,
                                   size_t descrA, size_t csrSortedValA,
                                   size_t csrSortedRowPtrA,
                                   size_t csrSortedColIndA, size_t info):
        cdef int pBufferSizeInBytes
    ...
    cpdef int zcsrilu02_bufferSize(intptr_t handle, int m, int nnz,
                                   size_t descrA,
                                   size_t csrSortedValA,
                                   size_t csrSortedRowPtrA,
                                   size_t csrSortedColIndA, size_t info):
        cdef int pBufferSizeInBytes
        _setStream(handle)
    ...
    cpdef sbsrilu02_numericBoost(intptr_t handle, size_t info,
                                 int enable_boost,
                                 size_t tol, size_t boost_val):
        _setStream(handle)
        with nogil:
    ...
    cpdef dbsrilu02_numericBoost(intptr_t handle, size_t info,
                                 int enable_boost,
                                 size_t tol, size_t boost_val):
        _setStream(handle)
        with nogil:
    ...
    cpdef cbsrilu02_numericBoost(intptr_t handle, size_t info,
                                 int enable_boost,
                                 size_t tol, size_t boost_val):
        _setStream(handle)
        with nogil:
    ...
    cpdef zbsrilu02_numericBoost(intptr_t handle, size_t info,
                                 int enable_boost,
                                 size_t tol, size_t boost_val):
        _setStream(handle)
        with nogil:
    ...
    cpdef int sbsrilu02_bufferSize(intptr_t handle, int dirA, int mb, int nnzb,
                                   ...
                                   size_t bsrSortedRowPtr,
                                   size_t bsrSortedColInd,
        ...
        with nogil:
            status = cusparseSbsrilu02_bufferSize(
                ...
                <const cusparseMatDescr_t>descrA, <float*>bsrSortedVal,
                <const int*>bsrSortedRowPtr, <const int*>bsrSortedColInd,
                blockDim, <bsrilu02Info_t>info, &pBufferSizeInBytes)
        check_status(status)
        return <int>pBufferSizeInBytes
    ...
    cpdef sbsrilu02_analysis(
        ...
        with nogil:
            status = cusparseSbsrilu02_analysis(
                ...
                <const cusparseMatDescr_t>descrA, <float*>bsrSortedVal,
                <const int*>bsrSortedRowPtr, <const int*>bsrSortedColInd,
                blockDim, <bsrilu02Info_t>info, <cusparseSolvePolicy_t>policy,
                <void*>pBuffer)
        check_status(status)
    ...
    cpdef sbsrilu02(intptr_t handle, int dirA, int mb, int nnzb, size_t descrA,
                    size_t bsrSortedVal, size_t bsrSortedRowPtr,
                    size_t bsrSortedColInd, int blockDim, size_t info,
                    int policy, size_t pBuffer):
        _setStream(handle)
        with nogil:
    ...
    cpdef int scsric02_bufferSize(intptr_t handle, int m, int nnz,
                                  size_t descrA,
                                  size_t csrSortedValA,
                                  size_t csrSortedRowPtrA,
                                  size_t csrSortedColIndA, size_t info):
    ...
    cpdef int dcsric02_bufferSize(intptr_t handle, int m, int nnz,
                                  size_t descrA,
                                  size_t csrSortedValA,
                                  size_t csrSortedRowPtrA,
                                  size_t csrSortedColIndA, size_t info):
    ...
    cpdef int ccsric02_bufferSize(intptr_t handle, int m, int nnz,
                                  size_t descrA,
                                  size_t csrSortedValA,
                                  size_t csrSortedRowPtrA,
                                  size_t csrSortedColIndA, size_t info):
    ...
    cpdef int zcsric02_bufferSize(intptr_t handle, int m, int nnz,
                                  size_t descrA,
                                  size_t csrSortedValA,
                                  size_t csrSortedRowPtrA,
                                  size_t csrSortedColIndA, size_t info):
    ...
    cpdef int sbsric02_bufferSize(intptr_t handle, int dirA, int mb, int nnzb,
        ...
        with nogil:
            status = cusparseSbsric02_bufferSize(
                ...
                <const cusparseMatDescr_t>descrA, <float*>bsrSortedVal,
                <const int*>bsrSortedRowPtr, <const int*>bsrSortedColInd,
                blockDim, <bsric02Info_t>info, &pBufferSizeInBytes)
        check_status(status)
        return <int>pBufferSizeInBytes
    ...
    cpdef sbsric02_analysis(
        ...
        with nogil:
            status = cusparseSbsric02_analysis(
                ...
                <const cusparseMatDescr_t>descrA, <const float*>bsrSortedVal,
                <const int*>bsrSortedRowPtr, <const int*>bsrSortedColInd,
                blockDim, <bsric02Info_t>info, <cusparseSolvePolicy_t>policy,
                <void*>pInputBuffer)
        check_status(status)
    ...
    cpdef sgtsv2_bufferSizeExt(intptr_t handle, int m, int n, size_t dl,
                               size_t d, size_t du, size_t B, int ldb,
                               size_t bufferSizeInBytes):
        _setStream(handle)
        with nogil:
            status = cusparseSgtsv2_bufferSizeExt(
                <cusparseHandle_t>handle, m, n, <const float*>dl,
                <const float*>d,
                <const float*>du, <const float*>B, ldb,
                <size_t*>bufferSizeInBytes)
        check_status(status)

    cpdef dgtsv2_bufferSizeExt(intptr_t handle, int m, int n, size_t dl,
                               size_t d, size_t du, size_t B, int ldb,
                               size_t bufferSizeInBytes):
        _setStream(handle)
        with nogil:
    ...
    cpdef cgtsv2_bufferSizeExt(intptr_t handle, int m, int n, size_t dl,
                               size_t d, size_t du, size_t B, int ldb,
                               size_t bufferSizeInBytes):
        _setStream(handle)
        with nogil:
    ...
    cpdef zgtsv2_bufferSizeExt(intptr_t handle, int m, int n, size_t dl,
                               size_t d, size_t du, size_t B, int ldb,
                               size_t bufferSizeInBytes):
        _setStream(handle)
        with nogil:
    ...
    cpdef sgtsv2_nopivot_bufferSizeExt(intptr_t handle, int m, int n,
                                       size_t dl,
                                       size_t d, size_t du, size_t B, int ldb,
                                       size_t bufferSizeInBytes):
        _setStream(handle)
    ...
    cpdef dgtsv2_nopivot_bufferSizeExt(intptr_t handle, int m, int n,
                                       size_t dl,
                                       size_t d, size_t du, size_t B, int ldb,
                                       size_t bufferSizeInBytes):
        _setStream(handle)
    ...
    cpdef cgtsv2_nopivot_bufferSizeExt(intptr_t handle, int m, int n,
                                       size_t dl,
                                       size_t d, size_t du, size_t B, int ldb,
                                       size_t bufferSizeInBytes):
        _setStream(handle)
    ...
    cpdef zgtsv2_nopivot_bufferSizeExt(intptr_t handle, int m, int n,
                                       size_t dl,
                                       size_t d, size_t du, size_t B, int ldb,
                                       size_t bufferSizeInBytes):
        _setStream(handle)
    ...
    cpdef dgtsv2StridedBatch_bufferSizeExt(
        ...
        with nogil:
            status = cusparseDgtsv2StridedBatch_bufferSizeExt(
                <cusparseHandle_t>handle, m, <const double*>dl,
                <const double*>d,
    ...
    cpdef sgtsv2StridedBatch(intptr_t handle, int m, size_t dl, size_t d,
                             size_t du, size_t x, int batchCount,
                             int batchStride, size_t pBuffer):
        _setStream(handle)
        with nogil:
    ...
    cpdef cgtsvInterleavedBatch(intptr_t handle, int algo, int m, size_t dl,
        ...
        with nogil:
            status = cusparseCgtsvInterleavedBatch(
                <cusparseHandle_t>handle, algo, m, <cuComplex*>dl,
                <cuComplex*>d,
    ...
    cpdef size_t sgpsvInterleavedBatch_bufferSizeExt(
        ...
        with nogil:
            status = cusparseSgpsvInterleavedBatch_bufferSizeExt(
                ...
                <const float*>dw, <const float*>x, batchCount,
                &pBufferSizeInBytes)
        check_status(status)
        return <size_t>pBufferSizeInBytes
    ...
    cpdef cgpsvInterleavedBatch(intptr_t handle, int algo, int m, size_t ds,
        ...
        with nogil:
            status = cusparseCgpsvInterleavedBatch(
                <cusparseHandle_t>handle, algo, m, <cuComplex*>ds,
                <cuComplex*>dl,
                <cuComplex*>d, <cuComplex*>du, <cuComplex*>dw, <cuComplex*>x,
                batchCount, <void*>pBuffer)
        check_status(status)
    ...
    cpdef dnMatSetStridedBatch(size_t desc, int batchCount,
                               int64_t batchStride):
    ...
    cpdef size_t spMV_bufferSize(intptr_t handle, Operation opA,
                                 intptr_t alpha,
    ...
    cpdef spMV(intptr_t handle, Operation opA, intptr_t alpha, size_t matA,
        ...
        _setStream(handle)
        status = cusparseSpMV(<Handle>handle, opA, <void*>alpha,
                              <SpMatDescr>matA,
    ...
    cpdef size_t spSM_bufferSize(intptr_t handle, Operation opA, Operation opB,
                                 ...
                                 size_t spsmDescr):
        cdef size_t bufferSize
        status = cusparseSpSM_bufferSize(<Handle>handle, opA, opB,
                                         <void*>alpha,
    ...
    cpdef spSM_solve(intptr_t handle, Operation opA, Operation opB,
                     intptr_t alpha,
                     size_t matA, size_t matB, size_t matC,
                     DataType computeType,
        ...
        IF CUPY_HIP_VERSION > 0:
            ...
            status = cusparseSpSM_solve(<Handle> handle, opA, opB,
                                        <void*>alpha,
                                        <SpMatDescr>matA, <DnMatDescr>matB,
                                        <DnMatDescr>matC, computeType, alg,
                                        <SpSMDescr>spsmDescr,
    ...
    cpdef size_t spMM_bufferSize(intptr_t handle, Operation opA, Operation opB,
                                 ...
                                 SpMMAlg alg):
        cdef size_t bufferSize
        status = cusparseSpMM_bufferSize(<Handle>handle, opA, opB,
                                         <void*>alpha,
                                         <SpMatDescr>matA, <DnMatDescr>matB,
    ...
    cpdef gather(intptr_t handle, size_t vecY, size_t vecX):
        status = cusparseGather(<Handle>handle, <DnVecDescr>vecY,
                                <SpVecDescr>vecX)
        check_status(status)
    ...
    cpdef size_t csr2cscEx2_bufferSize(
        ...
        cdef size_t bufferSize
        status = cusparseCsr2cscEx2_bufferSize(
            <Handle>handle, m, n, nnz, <const void*>csrVal,
            <const int*>csrRowPtr,
