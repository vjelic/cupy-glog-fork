...
cdef extern from *:
    ...
    IF CUPY_HIP_VERSION != 0:
        ctypedef int Operation 'hipsolverOperation_t'
        ctypedef int SideMode 'hipsolverSideMode_t'
        ctypedef int FillMode 'hipsolverFillMode_t'
    ELSE:
    ...
    IF CUPY_HIP_VERSION != 0:
        ctypedef void* cuComplex 'hipComplex'
        ctypedef void* cuDoubleComplex 'hipDoubleComplex'
    ELSE:
